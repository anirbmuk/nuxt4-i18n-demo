...
export default defineNuxtConfig({
  ...
  i18n: {
    locales: [
      ...
      { code: 'en-us', language: 'en-US', domain: 'localhost:3000', file: 'en_US.json' },
      ...
      { code: 'bn-in', language: 'bn-IN', domain: 'bn-in.localhost:3000', file: 'bn_IN.json', domainDefault: true },
    ],
